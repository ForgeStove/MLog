...
public class LinkDragController {
	...
	private @Nullable ParamElement.Node node;
	...
	public @Nullable ParamElement.Node node() {
		return node;
	}
	...
	public void begin(ParamElement.Node node, StatementCard source, double mouseX, double mouseY) {
		this.node = node;
		this.source = source;
		this.mouseX = mouseX;
		this.mouseY = mouseY;
